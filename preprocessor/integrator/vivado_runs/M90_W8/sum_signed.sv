...
module sum_signed #(
    parameter int M = 90,   // number of inputs
...
// Odd input passthrough
    ...
    assign w_reduce_layer222 = reduce_layer144;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer222 <= '0;
      else
...
// Odd input passthrough
    ...
    assign w_reduce_layer311 = reduce_layer222;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer311 <= '0;
      else
...
// Odd input passthrough
    ...
    assign w_reduce_layer61 = reduce_layer52;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer61 <= '0;
      else
