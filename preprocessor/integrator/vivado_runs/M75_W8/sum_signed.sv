...
module sum_signed #(
    parameter int M = 75,   // number of inputs
...
// Odd input passthrough
    ...
    assign w_reduce_layer137 = reduce_layer074;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer137 <= '0;
      else
...
// Odd input passthrough
    ...
    assign w_reduce_layer39 = reduce_layer218;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer39 <= '0;
      else
...
// Odd input passthrough
    ...
    assign w_reduce_layer52 = reduce_layer44;
    always_ff @(posedge clk) begin
      if (rst)
        reduce_layer52 <= '0;
      else
