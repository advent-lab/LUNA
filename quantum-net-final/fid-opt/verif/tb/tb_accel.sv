...
module tb_accel;
    ...
    reg [6:0] i_memory [0:WINDOW_SIZE-1];
    reg [6:0] q_memory [0:WINDOW_SIZE-1];
    ...
    reg [55:0] logicnet_mem [0 : N_SAMPLES - 1];
    ...
    initial begin
        ...
        for (int test = 0; test < N_SAMPLES; test = test + 1) begin
            ...
            for (int t = 0; t < WINDOW_SIZE; t = t + 1) begin
                ...
                // I is [31:18], shift right by SHIFT_M=7 means slice is [31 : 18+7] = [31:25]
                // Wait! In standard Verilog indexing, axis_word[31:25] is just that. 
                i_memory[t] = axis_word[31:25];
                // Q is [17:4], shift right by SHIFT_M=7 means slice is [17 : 4+7] = [17:11]
                q_memory[t] = axis_word[17:11];
            end
