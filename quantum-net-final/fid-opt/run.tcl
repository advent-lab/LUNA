...
# Part for ZCU216: XCZU49DR-2FFVF1760 (Zynq UltraScale+ RFSoC Gen 3)
create_project fid-opt-classifier ./fid-opt-classifer -part xczu49dr-ffvf1760-2-e -force

# Set the current project for subsequent commands
# Using the board_part property is recommended for board-specific settings (like clocks, I/Os)
#set_property board_part xilinx.com:zcu216:part0:1.0 [current_project]
# Note: You may need to change the 'board_part' revision if using a different version.
