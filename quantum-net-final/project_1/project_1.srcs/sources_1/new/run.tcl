...
create_project fid-opt-classifier ./fid-opt-classifer -part xczu7ev-ffvc1156-2-e
...
report_utilization -file ./nn_classifier_project/util_project.rpt
report_timing_summary -file ./nn_classifier_project/timing_project.rpt
