...
// Registers
    ...
    logic signed [5:0] reduce_layer175;
    logic signed [5:0] reduce_layer176;
    logic signed [5:0] reduce_layer177;
    logic signed [5:0] reduce_layer178;
    logic signed [5:0] reduce_layer179;
    logic signed [5:0] reduce_layer180;
    logic signed [5:0] reduce_layer181;
    logic signed [5:0] reduce_layer182;
    logic signed [5:0] reduce_layer183;
    logic signed [5:0] reduce_layer184;
    logic signed [5:0] reduce_layer185;
    logic signed [5:0] reduce_layer186;
    logic signed [5:0] reduce_layer187;
    logic signed [5:0] reduce_layer188;
    logic signed [5:0] reduce_layer189;
    logic signed [5:0] reduce_layer190;
    logic signed [5:0] reduce_layer191;
    logic signed [5:0] reduce_layer192;
    logic signed [5:0] reduce_layer193;
    logic signed [5:0] reduce_layer194;
    logic signed [5:0] reduce_layer195;
    logic signed [5:0] reduce_layer196;
    logic signed [5:0] reduce_layer197;
    logic signed [5:0] reduce_layer198;
    logic signed [5:0] reduce_layer199;
...
// Registers
    ...
    logic signed [6:0] reduce_layer238;
    logic signed [6:0] reduce_layer239;
    logic signed [6:0] reduce_layer240;
    logic signed [6:0] reduce_layer241;
    logic signed [6:0] reduce_layer242;
    logic signed [6:0] reduce_layer243;
    logic signed [6:0] reduce_layer244;
    logic signed [6:0] reduce_layer245;
    logic signed [6:0] reduce_layer246;
    logic signed [6:0] reduce_layer247;
    logic signed [6:0] reduce_layer248;
    logic signed [6:0] reduce_layer249;
...
// Registers
    ...
    logic signed [7:0] reduce_layer319;
    logic signed [7:0] reduce_layer320;
    logic signed [7:0] reduce_layer321;
    logic signed [7:0] reduce_layer322;
    logic signed [7:0] reduce_layer323;
    logic signed [7:0] reduce_layer324;
...
// Adders
    ...
    logic signed [8:0] w_reduce_layer410;
    assign w_reduce_layer410 = reduce_layer320 + reduce_layer321;
    logic signed [8:0] w_reduce_layer411;
...
// Registers
    ...
    logic signed [8:0] reduce_layer410;
    logic signed [8:0] reduce_layer411;
...
// Odd input passthrough
    logic signed [8:0] w_reduce_layer412;
    logic signed [8:0] reduce_layer412;
...
// Adders
    ...
    logic signed [9:0] w_reduce_layer55;
...
// Registers
    ...
    logic signed [9:0] reduce_layer55;
...
// Odd input passthrough
    logic signed [9:0] w_reduce_layer56;
    logic signed [9:0] reduce_layer56;
...
// Odd input passthrough
    logic signed [10:0] w_reduce_layer63;
    logic signed [10:0] reduce_layer63;
